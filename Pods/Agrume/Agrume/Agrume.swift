...
public final class Agrume: UIViewController {
    ...
    func updateLikesCount(count: Int) -> Void {
        let likeString = count == 1 ? "like" : "likes"
        self.countLikesLabel.text = "\(count) \(likeString)"
    }
...
extension Agrume: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        updateLikesCount(count: Int(arc4random_uniform(10)))
